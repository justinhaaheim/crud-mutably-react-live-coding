...
- Can use React in the front-end
...
- Are interested in using React in your applications
...
Your goal is to build a React front-end that consumes the Mutably API. You can choose any one of the 3 resources. Your front-end needs to complete all of the CRUD (Create, Read, Update, Delete) functions.

For the goal, fork this repository to get started.
...
This goal is also designed as an introduction to React. Please refer to [docs](https://reactjs.org/docs/hello-world.html) as needed.

### Note:
- `npm install` in the project directory after cloning the repo
- `yarn start` to launch app in the browser
- `MainFrame`, `Dashboard` and `Showcase` components have been created for you.

* This scaffolding uses `create-react-app`. If you would like to setup and configure React in your project, check out `react-setup.md`.

## Specifications

- Your repo is a fork of [mutably-starter](https://github.com/GuildCrafts/this/project).
...
- Create another version of your front-end using a front-end framework such as Vue or Angular.
